  ...
  ({ className, ...props }, ref) => (
    ...
    >
      <SwitchPrimitives.Thumb
        className={cn(
          'pointer-events-none block h-5 w-5 rounded-full bg-background dark:bg-background-dark shadow-md shadow-foreground/5 ring-0 transition-transform',
      ...
      >
        ...
        >
          <Animated.View style={animatedThumbStyle}>
            <SwitchPrimitives.Thumb
              className={'h-7 w-7 rounded-full bg-background dark:bg-background-dark shadow-md shadow-foreground/25 ring-0'}
            />
          </Animated.View>
        </SwitchPrimitives.Root>
      </Animated.View>
