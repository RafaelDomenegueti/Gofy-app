import { Construction, Heart } from "lucide-react-native";
...
export function CommunityScreen() {
  ...
  return (
    <View className="flex flex-col items-center justify-center flex-1 text-center p-6 bg-background dark:bg-background-dark">
      <Animated.View
      ...
      >
        <View className="w-24 h-24 rounded-full bg-primary flex items-center justify-center">
          <Construction className="h-12 w-12" color="#fff" />
        </View>
      </Animated.View>
      ...
      <Animated.View entering={FadeInUp.delay(400).springify()} className="flex flex-col items-center justify-center">
        ...
        <P className="text-muted-foreground mb-4 max-w-xs text-center leading-relaxed text-base">
          {t('community.constructionDescription')}
        </P>

        <P className="text-muted-foreground mb-8 max-w-xs text-center leading-relaxed text-base">
          {t('community.donationDescription')}
        </P>
      </Animated.View>
      ...
      <Animated.View entering={FadeInUp.delay(600).springify()}>
        ...
        >
          <View className="flex flex-row items-center justify-center gap-2">
            ...
            <Text className="text-white font-semibold text-base">{t('community.donate')}</Text>
          </View>
        </Button>
      </Animated.View>
    </View>
